package fr.denoria.api.spigot.utils;
...
public class Title {
	...
	public void sendTitle(ProxiedPlayer player, Integer fadeIn, Integer stay, Integer fadeOut, String message) {
        sendTitle(player, fadeIn, stay, fadeOut, message, null);
    }

    @Deprecated
    public void sendSubtitle(ProxiedPlayer player, Integer fadeIn, Integer stay, Integer fadeOut, String message) {
        sendTitle(player, fadeIn, stay, fadeOut, null, message);
    }

    @Deprecated
    public void sendFullTitle(ProxiedPlayer player, Integer fadeIn, Integer stay, Integer fadeOut, String title,
                              String subtitle) {
        sendTitle(player, fadeIn, stay, fadeOut, title, subtitle);
    }

    public void sendTitle(ProxiedPlayer player, Integer fadeIn, Integer stay, Integer fadeOut, String title,
                          String subtitle) {
    ...
    public void sendTabTitle(ProxiedPlayer player, String header, String footer) {
        if (header == null) {
            header = "";
        }
